...
class ActivityDetailsRepoImpl implements ActivityDetailsRepo {
  ...
  @override
  Future<Either<Failure, ActivityDetailsModel>> getActivityDetails({required int id}) async {
    ...
    try {
      final response = await dioConsumer.get('${EndPoints.activites}/${id.toString()}');
